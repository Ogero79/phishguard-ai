...
# Names match the headers in data/processed/X_train_features.csv exactly.
...
def extract_features(url: str) -> dict[str, float]:
    ...
    # ------------------------------------------------------------------ #
    # 5. has_at — '@' redirects browsers; strong phishing signal
    # ------------------------------------------------------------------ #
...
def feature_security_notes() -> dict[str, str]:
    ...
    return {
        ...
        "has_at": "The '@' character causes browsers to ignore everything before it — a strong phishing signal.",
        "has_https": "Absence of HTTPS is a weak but supporting phishing indicator.",
        "has_ip": "Legitimate services almost never use raw IP addresses in their URLs.",
